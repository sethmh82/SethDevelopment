# -*- coding: utf-8 -*-
"""
Created on Tue Dec 23 07:02:23 2020
...
parser.add_argument('abspath', type=str, help= 'C:\MAMP\htdocs')
parser.add_argument('pattern', type=str, help= '*.pdf')
...
start_depth = rootPath.count('C:\MAMP\htdocs')
